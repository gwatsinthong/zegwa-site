// Shared social links, used in the footer and on the Contact page.

export type Social = { label: string; path: string; href: string }

// HIDDEN (reversible): LinkedIn has no live profile to link to yet. Lifted
// out rather than deleted, mirroring the footer Verticals carve-out
// (components/Footer.tsx). To restore, move this back into SOCIALS below
// (it was originally first) once a real LinkedIn URL exists.
const hiddenLinkedIn: Social = {
  label: 'LinkedIn',
...
export const SOCIALS: Social[] = [
  // HIDDEN: LinkedIn lifted into `hiddenLinkedIn` above.
  {
    label: 'Instagram',
    ...
    href: 'https://www.instagram.com/zegwastudio',
  },
  {
    label: 'X',
