...
// the service to auto repair shops; no NAP, no LocalBusiness schema.
//
...
// FAQ, final CTA). Copy is auto repair's own -- carried over from the
...
const HOW_IT_WORKS = [
  ...
  "Found in AI search, when someone asks ChatGPT or Google's AI for a mechanic",
]
...
export default function AutoRepairPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1140px] flex-col items-start gap-[48px] md:flex-row md:gap-[64px]">
          <div className="flex w-full flex-col items-start gap-[32px] md:max-w-[480px]">
            <div className="flex flex-col items-start gap-[20px]">
              ...
              <p className="text-left text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
                We get your shop found on Google, on maps, and in AI search, so when someone
                nearby needs a mechanic they can trust, they find you first. Set up in days, then
                kept running.
              </p>
            </div>
          ...
          <div className="flex w-full flex-1 flex-col items-center gap-[12px]">
            <BrowserFrame
              src="/work/auto.webp"
              url="auto.zegwastudio.com"
              alt="Sample auto repair site"
      ...
      {/* ============ WHAT DOES AUTO REPAIR SEO DO (home dark-band pattern) ==== */}
      ...
      <section className="px-6 pb-[64px] sm:pb-[80px]">
        <div className="mx-auto flex max-w-[500px] flex-col items-center gap-[16px]">
          ...
          <p className="text-center text-[14px] leading-[1.5] text-[#777]">
            Auto repair SEO is local SEO built for one trade.{' '}
