...
export const metadata: Metadata = pageMeta({
  title: 'Auto repair shop SEO',
  description:
    'Auto repair shop SEO done for you. Get found on Google, maps, and AI search when someone nearby needs a mechanic. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/auto-repair',
})
...
// selling the service to auto repair shops; no NAP, no LocalBusiness schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack for repair searches near you',
  'Fix and build your listings across the directories drivers check',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a mechanic",
  'Set up review generation so new customer reviews keep coming in',
  'Give you one dashboard to see every search, visit, and review',
]

const FAQS = [
  {
    q: 'How do I get more customers from Google?',
    a: "Show up where people look when their car needs work. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
    q: 'How long until auto repair SEO shows results?',
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where you're losing customers to other shops, so you can judge the work before you decide anything.",
  },
]

const jsonLd = pageJsonLd({
  service: {
    name: 'Auto repair shop SEO',
    description:
      'Done-for-you SEO for auto repair shops: Google Business Profile, listings, reviews, and AI-search visibility.',
    url: `${SITE_URL}/auto-repair`,
...
export default function AutoRepairPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            <RuleRow>Auto repair SEO</RuleRow>
            <h1
            ...
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your shop found on Google, on maps, and in AI search, so when someone nearby
              needs a mechanic they can trust, they find you first. Set up in days, then kept
              running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other shops are outranking you first. Then you
              decide.
            </p>
          </Callout>
        </div>
      ...
      {/* ================ WHAT DOES AUTO REPAIR SEO DO (AEO explainer) ========= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          <h2 style={{ fontFamily: HELV }} className={`text-[#202020] ${FRAME_TYPE.h2}`}>
            What does auto repair shop SEO actually do?
          </h2>
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            Auto repair shop SEO makes your shop show up when someone nearby searches for a
            mechanic or a repair. It comes from a fully set-up Google Business Profile, the map
            pack, accurate directory listings, a steady flow of reviews, and being found in AI
            search when someone asks ChatGPT or Google&#39;s AI for a mechanic. That&#39;s what
            seo for auto repair shops actually covers: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample auto repair site.
          </p>
          <a
            href="https://auto.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Auto repair SEO is local SEO built for one trade. See how the whole system works:{' '}
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where other shops are outranking you, before you
              decide anything.
            </p>
          </div>
          <div className="flex flex-col items-center gap-[12px]">
