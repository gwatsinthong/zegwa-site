...
export const metadata: Metadata = pageMeta({
  title: 'Veterinary SEO',
  description:
    'Veterinary SEO done for you. Get found on Google, maps, and AI search when someone nearby needs a vet. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/veterinary',
})
...
// selling the service to veterinary practices; no NAP, no LocalBusiness
// schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack when someone searches for a vet near them',
  'Fix and build your listings across the directories pet owners check',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a vet",
...
const FAQS = [
  {
    ...
    a: "Show up where people look when their pet needs care. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
    q: 'How long until veterinary SEO shows results?',
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where you're losing clients to other practices, so you can judge the work before you decide anything.",
  },
]
...
const jsonLd = pageJsonLd({
  service: {
    name: 'Veterinary SEO',
    description:
      'Done-for-you SEO for veterinary practices: Google Business Profile, listings, reviews, and AI-search visibility.',
    url: `${SITE_URL}/veterinary`,
...
export default function VeterinaryPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            <RuleRow>Veterinary SEO</RuleRow>
            <h1
            ...
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your practice found on Google, on maps, and in AI search, so when a pet
              owner nearby needs a vet, they find you first. Set up in days, then kept running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other practices are outranking you first. Then you
              decide.
            </p>
          </Callout>
        </div>
      ...
      {/* =================== WHAT DOES VETERINARY SEO DO (AEO explainer) ======= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          <h2 style={{ fontFamily: HELV }} className={`text-[#202020] ${FRAME_TYPE.h2}`}>
            What does veterinary SEO actually do?
          </h2>
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            Veterinary SEO makes your practice show up when someone nearby searches for a vet or
            an animal hospital. It comes from a fully set-up Google Business Profile, the map
            pack, accurate directory listings, a steady flow of reviews, and being found in AI
            search when someone asks ChatGPT or Google&#39;s AI for a vet. That&#39;s what
            veterinary seo services actually cover: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample veterinary site.
          </p>
          <a
            href="https://vet.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Veterinary SEO is local SEO built for one profession. See how the whole system
            works:{' '}
