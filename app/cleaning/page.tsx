...
export const metadata: Metadata = pageMeta({
  title: 'Marketing for cleaning companies',
  description:
    'Get your cleaning company found by customers searching nearby. Website, Google presence, and reviews, done for you. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/cleaning',
})
...
const WHAT_YOU_GET = [
  'A fast, professional website built to get customers to book',
  'Your Google Business Profile set up and ranking when customers search nearby',
  'Consistent listings across the directories customers check',
  'Reviews set up so new customer reviews keep coming in',
...
const FAQS = [
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where customers are looking, so you can judge the work before you decide anything.",
  },
]

const jsonLd = pageJsonLd({
  service: {
    name: 'Marketing for cleaning companies',
    description:
      'Done-for-you web presence for cleaning companies: website, Google Business Profile, listings, and reviews.',
    ...
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            <RuleRow>Cleaning companies</RuleRow>
            <h1
              style={{ fontFamily: HELV }}
              className={`max-w-[704px] text-center text-[#202020] ${FRAME_TYPE.display}`}
            >
              Get your cleaning company found
            </h1>
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We build your web presence and get your company found by the customers already
              searching for a cleaner nearby. Set up in days, then kept running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where customers are looking and whether they can find you
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
              Everything that gets your company found, set up once and kept running:
            </p>
          </div>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample cleaning company site.
          </p>
          <a
            href="https://cleaning.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 py-[80px] sm:py-[100px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            >
              See where your customers are looking.
            </h2>
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where customers search and whether they can find
