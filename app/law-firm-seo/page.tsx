...
export const metadata: Metadata = pageMeta({
  ...
  description:
    'SEO for law firms done for you, with a focus on personal injury. Get found on Google, maps, and AI search when someone needs a lawyer. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/law-firm-seo',
})

// Vertical service page, built in the same shape as app/roofing/page.tsx and
// app/plumbing/page.tsx (and the app/local-seo/page.tsx pillar): same
// primitives, same section rhythm, same FAQS-array-shared-with-pageJsonLd
// approach. Marketing-site page selling the service to law firms, personal
// injury as the lead specialization, not a PI-only page; no NAP, no
// LocalBusiness schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack when someone searches for a lawyer near them',
  'Fix and build your listings across the directories people check when they need legal help',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a lawyer",
  'Set up review generation so new client reviews keep coming in',
  'Give you one dashboard to see every search, visit, and review',
]

const FAQS = [
  {
    q: 'How do I get more cases from Google?',
    a: "Show up where people look when they need a lawyer. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
    q: 'How long until law firm SEO shows results?',
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where you're losing cases to other firms, so you can judge the work before you decide anything.",
  },
]
...
const jsonLd = pageJsonLd({
  service: {
    ...
    description:
      'Done-for-you SEO for law firms, with a focus on personal injury: Google Business Profile, listings, reviews, and AI-search visibility.',
    url: `${SITE_URL}/law-firm-seo`,
...
export default function LawFirmSeoPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            ...
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your firm found on Google, on maps, and in AI search, so the cases come to
              you instead of the firm ranking above you. Built for law firms, with a focus on
              personal injury. Set up in days, then kept running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other firms are outranking you first. Then you
              decide.
            </p>
          </Callout>
        </div>
      ...
      {/* ===================== WHAT DOES LAW FIRM SEO DO (AEO explainer) ======= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          <h2 style={{ fontFamily: HELV }} className={`text-[#202020] ${FRAME_TYPE.h2}`}>
            What does law firm SEO actually do?
          </h2>
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            Law firm SEO makes your firm show up when someone nearby searches for a lawyer. It
            comes from a fully set-up Google Business Profile, the map pack, accurate directory
            listings, a steady flow of reviews, and being found in AI search when someone asks
            ChatGPT or Google&#39;s AI for a lawyer. That&#39;s what search engine optimization
            for lawyers actually covers, and it&#39;s the same core work behind local seo for
            lawyers everywhere: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample law firm site.
          </p>
          <a
            href="https://injury-law.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Law firm SEO is local SEO built for one profession. See how the whole system works:{' '}
      ...
      <section className="px-6 py-[80px] sm:py-[100px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            >
              See where you&#39;re losing cases.
            </h2>
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where other firms are outranking you, before you
              decide anything.
            </p>
          </div>
          <div className="flex flex-col items-center gap-[12px]">
