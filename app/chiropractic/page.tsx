...
// same FAQS-array-shared-with-pageJsonLd approach. No sample-site section --
// chiropractic is not one of our demo subdomains. Marketing-site page
// selling the service to chiropractors; no NAP, no LocalBusiness schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack when someone searches for a chiropractor near them',
  'Fix and build your listings across the directories patients check',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a chiropractor",
...
export default function ChiropracticPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other chiropractors are outranking you first. Then
              you decide.
            </p>
          </Callout>
        </div>
      ...
      {/* ================= WHAT DOES CHIROPRACTOR SEO DO (AEO explainer) ======= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          ...
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            ...
            chiropractor. It comes from a fully set-up Google Business Profile, the map pack,
            accurate directory listings, a steady flow of reviews, and being found in AI search
            when someone asks ChatGPT or Google&#39;s AI for a chiropractor. That&#39;s what
            chiropractor search engine optimization actually covers, and it&#39;s the same core
            work behind local seo for chiropractors everywhere: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Chiropractor SEO is local SEO built for one profession. See how the whole system
            works:{' '}
