...
import { CheckListDark } from '@/components/vertical-sections'
import PricingCards from '@/components/PricingCards'

export const metadata: Metadata = pageMeta({
  title: 'Chiropractor SEO',
  description:
    'Chiropractor SEO done for you. Get found on Google, maps, and AI search when someone nearby needs a chiropractor. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/chiropractic',
})

// Vertical service page, brought in line with app/roofing/page.tsx's current
// shape (gradient-bracketed statement, bento WHAT_WE_DO grid, dark
// "how it works" band, combined you-own-everything + local-SEO-link-up
// closing section) after drifting from it -- this page predates the several
// rounds of revision roofing went through to reach that shape (see git log)
// and was never brought forward. One deliberate remaining difference: the
// hero stays the plain centered layout rather than roofing's split
// hero+BrowserFrame, because chiropractic has no real sample site to show --
// there's no /work/chiropractic.webp and inventing one would be a fake demo
// link. Marketing-site page selling the service to chiropractors; no NAP, no
// LocalBusiness schema.

const WHAT_WE_DO = [
  { title: 'Map pack ranking', desc: 'Rank in the map pack near you' },
  { title: 'Directory listings', desc: 'Fixed everywhere patients look you up' },
...
const HOW_IT_WORKS = [
  ...
  'A steady flow of new patient reviews',
  "Found in AI search, when someone asks ChatGPT or Google's AI for a chiropractor",
]

const FAQS = [
  {
    q: 'How do I get more patients from Google?',
    a: "Show up where people look when they need a chiropractor. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
    q: 'How long until chiropractor SEO shows results?',
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where you're losing patients to other practices, so you can judge the work before you decide anything.",
  },
]
...
const jsonLd = pageJsonLd({
  service: {
    ...
    description:
      'Done-for-you SEO for chiropractors: Google Business Profile, listings, reviews, and AI-search visibility.',
...
export default function ChiropracticPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            <RuleRow>Chiropractor SEO</RuleRow>
            <h1
              style={{ fontFamily: HELV }}
              className={`max-w-[704px] text-balance text-center text-[#202020] ${FRAME_TYPE.display}`}
            >
              Chiropractor SEO
            </h1>
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your practice found on Google, on maps, and in AI search, so when someone
              nearby searches for a chiropractor, they find you first. Set up in days, then kept
              running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[590px] flex-col items-center gap-[64px]">
          ...
          <div className="text-[24px] font-bold leading-[1.32] tracking-[-0.72px] text-[#202020] sm:text-[36px] sm:tracking-[-1.08px]">
            <p className="text-balance text-[#777]">
              ...
              audit shows you exactly where other chiropractors are outranking you first. Then you
              decide.
            </p>
          </div>
          <div
      ...
      {/* ================= WHAT DOES CHIROPRACTOR SEO DO (home dark-band pattern) === */}
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[40px] text-center">
          <div className="flex flex-col items-center gap-[24px]">
            ...
            <h2 style={{ fontFamily: HELV }} className="text-balance text-[32px] font-bold leading-[1.24] tracking-[-0.96px] text-[#fefefe] sm:text-[48px] sm:tracking-[-1.44px]">
              What does chiropractor SEO actually do?
            </h2>
            <p className="text-balance text-[24px] font-bold leading-[1.32] tracking-[-0.72px] text-[#fefefe] sm:text-[28px]">
              Chiropractor SEO makes your practice show up when someone nearby searches for a
              chiropractor.
            </p>
          </div>
      ...
      <section className="px-6 pb-[64px] sm:pb-[80px]">
        <div className="mx-auto flex max-w-[500px] flex-col items-center gap-[16px]">
          ...
          <p className="text-center text-[14px] leading-[1.5] text-[#777]">
            Chiropractor SEO is local SEO built for one profession.{' '}
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where other chiropractors are outranking you,
