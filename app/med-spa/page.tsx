...
export const metadata: Metadata = pageMeta({
  ...
  description:
    'Marketing for med spas done for you. Get found on Google, maps, and AI search when someone nearby is looking for treatments. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/med-spa',
})

// Vertical service page, built in the same shape as app/plumbing/page.tsx (and
...
// selling the service to med spas; no NAP, no LocalBusiness schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack when someone searches for a med spa near them',
  'Fix and build your listings across the directories people check when they research treatments',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a med spa",
...
const FAQS = [
  {
    q: 'How do I get more clients from Google?',
    a: "Show up where people look when they're researching treatments. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
  ...
  },
  {
    ...
    a: "No. We're new and we don't have case studies yet. That's why we lead with a free audit that shows you exactly where you're losing clients to other med spas, so you can judge the work before you decide anything.",
  },
]
...
const jsonLd = pageJsonLd({
  service: {
    ...
    description:
      'Done-for-you marketing for med spas: Google Business Profile, listings, reviews, and AI-search visibility.',
    url: `${SITE_URL}/med-spa`,
...
export default function MedSpaPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
      ...
      <section className="px-6 pb-[80px] pt-[64px] sm:pb-[100px] sm:pt-[80px]">
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            <RuleRow>Med spa marketing</RuleRow>
            <h1
            ...
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your med spa found on Google, on maps, and in AI search, so when someone
              nearby is looking for treatments, they find you and see your reviews before they
              book. Set up in days, then kept running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other med spas are outranking you first. Then you
              decide.
            </p>
          </Callout>
        </div>
      ...
      {/* ==================== WHAT DOES MED SPA MARKETING DO (AEO) ============= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          <h2 style={{ fontFamily: HELV }} className={`text-[#202020] ${FRAME_TYPE.h2}`}>
            What does med spa marketing actually do?
          </h2>
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            Med spa marketing makes your business show up when someone nearby searches for a med
            spa or a treatment you offer. It comes from a fully set-up Google Business Profile,
            the map pack, accurate directory listings, a steady flow of reviews, and being found
            in AI search when someone asks ChatGPT or Google&#39;s AI for a med spa. That&#39;s
            what seo for medical spas actually covers, and it&#39;s the same core work behind med
            spa digital marketing everywhere: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample med spa site.
          </p>
          <a
            href="https://med-spa.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Med spa marketing is local SEO built for one business. See how the whole system
            works:{' '}
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where other med spas are outranking you, before
              you decide anything.
            </p>
          </div>
          <div className="flex flex-col items-center gap-[12px]">
