...
export const metadata: Metadata = pageMeta({
  title: 'Dental SEO',
  description:
    'Dental SEO done for you. Get found on Google, maps, and AI search when someone nearby needs a dentist. Setup $1,500, then $500 a month. No minimum. You own everything.',
  path: '/dental',
})
...
// selling the service to dental practices; no NAP, no LocalBusiness schema.

const WHAT_WE_DO = [
  'Get your Google Business Profile ranking in the map pack when someone searches for a dentist near them',
  'Fix and build your listings across the directories patients check',
  "Get you found in AI search, when someone asks ChatGPT or Google's AI for a dentist",
  'Set up review generation so new patient reviews keep coming in',
...
const FAQS = [
  {
    ...
    a: "Show up where people look when they need a dentist. That means a complete Google Business Profile, consistent listings, and a steady flow of reviews, so you appear in the map pack and in search. That's the core of what we set up and keep running.",
  },
  {
    q: 'How long until dental SEO shows results?',
...
const jsonLd = pageJsonLd({
  service: {
    name: 'Dental SEO',
    description:
      'Done-for-you SEO for dental practices: Google Business Profile, listings, reviews, and AI-search visibility.',
    url: `${SITE_URL}/dental`,
...
export default function DentalPage() {
  return (
    <div style={{ fontFamily: HELV }} className="text-[#202020]">
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[48px]">
          <div className="flex flex-col items-center gap-[26px]">
            ...
            <p className="max-w-[560px] text-center text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              We get your dental practice found on Google, on maps, and in AI search, so new
              patients searching for a dentist nearby find you instead of the practice down the
              street. Set up in days, then kept running.
            </p>
          </div>
        ...
        <div className="mx-auto flex max-w-[700px] flex-col items-center">
          <Callout className="text-center">
            <p className="text-[18px] leading-[1.5] text-[#202020] sm:text-[20px]">
              ...
              audit shows you exactly where other dental practices are outranking you first. Then
              you decide.
            </p>
          </Callout>
        </div>
      ...
      {/* ===================== WHAT DOES DENTAL SEO DO (AEO explainer) ========= */}
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[24px] text-center">
          <h2 style={{ fontFamily: HELV }} className={`text-[#202020] ${FRAME_TYPE.h2}`}>
            What does dental SEO actually do?
          </h2>
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c] sm:text-[18px]">
            Dental SEO makes your practice show up when someone nearby searches for a dentist. It
            ...
            ChatGPT or Google&#39;s AI for a dentist. That&#39;s what seo for dental practice
            actually covers, and it&#39;s the same core work behind local seo for dentists
            everywhere: all of it, kept running together.
          </p>
        </div>
      </section>
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center gap-[8px] text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Want to see the kind of site we build? Here&#39;s a sample dental site.
          </p>
          <a
            href="https://dental.zegwastudio.com"
            target="_blank"
      ...
      <section className="px-6 pb-[80px] sm:pb-[100px]">
        <div className="mx-auto flex max-w-[700px] flex-col items-center text-center">
          <p className="text-[16px] leading-[1.5] text-[#5c5c5c]">
            Dental SEO is local SEO built for one profession. See how the whole system works:{' '}
        ...
        <div className="mx-auto flex max-w-[1040px] flex-col items-center gap-[40px]">
          <div className="flex flex-col items-center gap-[24px] text-center">
            ...
            <p className="max-w-[503px] text-[18px] leading-[1.5] text-[#5c5c5c] sm:text-[20px]">
              The free audit shows you exactly where other practices are outranking you, before
              you decide anything.
            </p>
          </div>
          <div className="flex flex-col items-center gap-[12px]">
